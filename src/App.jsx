...
const courseSteps = [
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <VideoEmbed
          url="https://drive.google.com/file/d/1vS8u_y86q4T6A1S-Xv7I8v5r5v5v5v5/view"
          title="AGV Concept Walkthrough"
        />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-center py-12">
        ...
        <SlideDeckEmbed
          url="https://docs.google.com/presentation/d/1vS8u_y86q4T6A1S-Xv7I8v5r5v5v5v5/edit"
          title="AGV Post-Course Reference"
        />
...
export default function App() {
  ...
  const [completedSteps, setCompletedSteps] = useState([0]); // Initialize with first step completed
